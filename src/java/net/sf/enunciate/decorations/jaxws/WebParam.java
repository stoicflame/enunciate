...
public class WebParam extends DecoratedParameterDeclaration implements SimpleWebMessage, ComplexWebMessage, WebMessagePart {
  ...
  public String getTargetNamespace() {
    ...
    if ((targetNamespace == null) || ("".equals(targetNamespace))) {
      targetNamespace = this.method.getDeclaringWebService().getTargetNamespace();
    }
  ...
  /**
   * The SOAP binding use of this web param.
   *
   * @return The SOAP binding use of this web param.
   */
