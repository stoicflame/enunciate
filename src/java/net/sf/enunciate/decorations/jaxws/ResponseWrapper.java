...
public class ResponseWrapper implements ComplexWebMessage, WebMessagePart {
  ...
  public ResponseWrapper(WebMethod webMethod) {
    ...
    if (webMethod.isOneWay()) {
      throw new IllegalArgumentException("A one-way method cannot have a response wrapper.");
    }
  }
  ...
  public String getTargetNamespace() {
    String targetNamespace = webMethod.getDeclaringWebService().getTargetNamespace();
