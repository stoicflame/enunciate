 ...
 * @author Ryan Heaton
 */
public class InterfaceJackson1TypeElement implements TypeElementAdaptor {

  private final DeclaredType root;
  private final TypeElement element;
  private final DecoratedProcessingEnvironment env;

  public InterfaceJackson1TypeElement(DeclaredType root, DecoratedProcessingEnvironment env) {
    this.root = root;
    this.env = env;
  ...
  public TypeMirror asType() {
    return new InterfaceJackson1DeclaredType(this.root, this.env);
  }
  ...
  private class InterfaceExecutable implements ExecutableElementAdaptor {
    ...
    @Override
    public Element getEnclosingElement() {
      return InterfaceJackson1TypeElement.this;
    }
