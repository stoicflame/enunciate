...
public class MapType extends DecoratedDeclaredType {
   ...
   */
  public static MapType findMapType(TypeMirror typeMirror, EnunciateJackson1Context context) {
  ...
  private static DeclaredType findMapTypeDeclaration(TypeMirror typeMirror, EnunciateJackson1Context context) {
    if (!(typeMirror instanceof DeclaredType)) {
      return null;
    }
