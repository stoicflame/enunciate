...
import com.webcohesion.enunciate.modules.jackson1.model.types.KnownXmlType;
...
public class EnunciateJaxbContext extends EnunciateModuleContext {
  ...
  protected void add(TypeDefinition typeDef, LinkedList<Element> stack) {
    ...
    if (findTypeDefinition(typeDef) == null && !isKnownType(typeDef)) {
      ...
      try {
        ...
        for (com.webcohesion.enunciate.modules.jackson1.model.Element element : typeDef.getElements()) {
   ...
   * @param stack The context stack.
   */
  protected void addReferencedTypeDefinitions(com.webcohesion.enunciate.modules.jackson1.model.Element element, LinkedList<Element> stack) {
    ...
    if (element instanceof ElementRef && element.isCollectionType()) {
      ...
      for (com.webcohesion.enunciate.modules.jackson1.model.Element choice : element.getChoices()) {
   ...
   */
  protected ImplicitSchemaElement getImplicitElement(com.webcohesion.enunciate.modules.jackson1.model.Element element) {
