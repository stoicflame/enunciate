...
public class TestJAXWSValidator extends InAPTTestCase {
  ...
  public void testConflictingBeanNames() throws Exception {
    ...
    WebFault webFault = new WebFault((ClassDeclaration) getDeclaration("net.sf.enunciate.samples.jaxws.BasicFault"));
    visited.clear();
    ...
    webFault = new WebFault((ClassDeclaration) getDeclaration("net.sf.enunciate.samples.jaxws.NonConflictingFault"));
