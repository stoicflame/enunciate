...
public class TestRESTOperation extends TestCase {
  ...
  public void testPing() throws Exception {
    RESTOperation operation = new RESTOperation(null, VerbType.read, new RESTOperationExamples(), RESTOperationExamples.class.getMethod("ping"), null);
  ...
  public void testBadReturnType() throws Exception {
    try {
      new RESTOperation(null, VerbType.read, new RESTOperationExamples(), RESTOperationExamples.class.getMethod("badReturnType"), null);
  ...
  public void testProperNoun() throws Exception {
    RESTOperation operation = new RESTOperation(null, VerbType.read, new RESTOperationExamples(), RESTOperationExamples.class.getMethod("properNoun", String.class), null);
    assertEquals(VerbType.read, operation.getVerb());
    assertNull(operation.getNounValueType());
    assertTrue(operation.getAdjectiveTypes().isEmpty());
    assertNotNull(operation.getSerializationContext());
  ...
  public void testBadProperNoun() throws Exception {
    try {
      new RESTOperation(null, VerbType.read, new RESTOperationExamples(), RESTOperationExamples.class.getMethod("badProperNoun", String[].class), null);
  ...
  public void testTwoProperNouns() throws Exception {
    try {
      new RESTOperation(null, VerbType.read, new RESTOperationExamples(), RESTOperationExamples.class.getMethod("twoProperNouns", String.class, String.class), null);
  ...
  public void testNounValue() throws Exception {
    RESTOperation operation = new RESTOperation(null, VerbType.update, new RESTOperationExamples(), RESTOperationExamples.class.getMethod("nounValue", RootElementExample.class), null);
  ...
  public void testBadNounValue() throws Exception {
    try {
      new RESTOperation(null, VerbType.update, new RESTOperationExamples(), RESTOperationExamples.class.getMethod("badNounValue", Object.class), null);
  ...
  public void testTwoNounValues() throws Exception {
    try {
      new RESTOperation(null, VerbType.update, new RESTOperationExamples(), RESTOperationExamples.class.getMethod("twoNounValues", RootElementExample.class, RootElementExample.class), null);
  ...
  public void testDefaultAdjectives() throws Exception {
    RESTOperation operation = new RESTOperation(null, VerbType.read, new RESTOperationExamples(), RESTOperationExamples.class.getMethod("defaultAdjectives", String.class, Double.TYPE), new String[]{null, "secondAdjective"});
    assertEquals(VerbType.read, operation.getVerb());
    assertNull(operation.getProperNounType());
    assertNull(operation.getNounValueType());
    assertNotNull(operation.getSerializationContext());
  ...
  public void testCustomAdjectives() throws Exception {
    RESTOperation operation = new RESTOperation(null, VerbType.read, new RESTOperationExamples(), RESTOperationExamples.class.getMethod("customAdjectives", String.class, Double.TYPE), null);
    assertEquals(VerbType.read, operation.getVerb());
    assertNull(operation.getProperNounType());
    assertNull(operation.getNounValueType());
    assertNotNull(operation.getSerializationContext());
  ...
  public void testAdjectivesAsLists() throws Exception {
    RESTOperation operation = new RESTOperation(null, VerbType.read, new RESTOperationExamples(), RESTOperationExamples.class.getMethod("adjectivesAsLists", boolean[].class, Collection.class), null);
    assertEquals(VerbType.read, operation.getVerb());
    assertNull(operation.getProperNounType());
    assertNull(operation.getNounValueType());
    assertNotNull(operation.getSerializationContext());
  ...
  public void testInvoke() throws Exception {
    RESTOperation operation = new RESTOperation(null, VerbType.read, new RESTOperationExamples(), RESTOperationExamples.class.getMethod("invokeableOp", RootElementExample.class, String.class, Float.class, Collection.class), null);
  ...
  public void testInvoke2() throws Exception {
    RESTOperation operation = new RESTOperation(null, VerbType.read, new RESTOperationExamples(), RESTOperationExamples.class.getMethod("invokeableOp2", RootElementExample.class, String.class, Float.class), null);
    HashMap<String, Object> adjectives = new HashMap<String, Object>();
    adjectives.put("hi", new Float(1234.5));
