...
public class TestElementRef extends TestElement {
  ...
  public void testBasicElementRef() throws Exception {
    ...
    ComplexTypeDefinition typeDef = new ComplexTypeDefinition((ClassDeclaration) getDeclaration("net.sf.enunciate.samples.schema.ElementRefBeanOne"));
  ...
  public void testBasicCollectionRef() throws Exception {
    ...
    ClassDeclaration decl = (ClassDeclaration) getDeclaration("net.sf.enunciate.samples.anotherschema.BeanOneDotOne");
    ...
    decl = (ClassDeclaration) getDeclaration("net.sf.enunciate.samples.anotherschema.BeanOneDotTwo");
    type = new ComplexTypeDefinition(decl);
    rootElementDeclaration = new RootElementDeclaration(decl, type);
    model.add(type);
    model.add(rootElementDeclaration);

    decl = (ClassDeclaration) getDeclaration("net.sf.enunciate.samples.anotherschema.BeanThree");
    type = new ComplexTypeDefinition(decl);
    rootElementDeclaration = new RootElementDeclaration(decl, type);
    model.add(type);
    model.add(rootElementDeclaration);

    decl = (ClassDeclaration) getDeclaration("net.sf.enunciate.samples.anotherschema.BeanFour");
    type = new ComplexTypeDefinition(decl);
    rootElementDeclaration = new RootElementDeclaration(decl, type);
    model.add(type);
    model.add(rootElementDeclaration);

    ComplexTypeDefinition typeDef = new ComplexTypeDefinition((ClassDeclaration) getDeclaration("net.sf.enunciate.samples.anotherschema.ElementRefsBean"));
  ...
  public void testSuperTypeCollectionRef() throws Exception {
    ...
    decl = (ClassDeclaration) getDeclaration("net.sf.enunciate.samples.anotherschema.BeanOne");
    type = new ComplexTypeDefinition(decl);
    model.add(type);
