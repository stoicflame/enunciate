...
public class TestRequestWrapper extends InAPTTestCase {
  ...
  public void testNamesAndProperties() throws Exception {
    EndpointInterface ei = new EndpointInterface(getDeclaration("net.sf.enunciate.samples.services.RequestWrapperExamples"));
    ...
    assertEquals("net.sf.enunciate.samples.services.FullyAnnotatedMethod", fullyAnnotatedWrapper.getRequestBeanName());
