...
public class TestWebFault extends InAPTTestCase {
  ...
  public void testDefaultImplicitWebFault() throws Exception {
    ...
    WebFault webFault = new WebFault((ClassDeclaration) getDeclaration("net.sf.enunciate.samples.services.ImplicitWebFault"));
    assertEquals("ImplicitWebFault", webFault.getMessageName());
    assertEquals("ImplicitWebFault", webFault.getElementName());
    assertEquals("net.sf.enunciate.samples.services.jaxws.ImplicitWebFaultBean", webFault.getImplicitFaultBeanQualifiedName());
    assertEquals("http://services.samples.enunciate.sf.net/", webFault.getTargetNamespace());
    ...
    assertEquals(new QName("http://services.samples.enunciate.sf.net/", "ImplicitWebFault"), webFault.getParticleQName());
  ...
  public void testImplicitWebFault() throws Exception {
    FreemarkerModel.set(new EnunciateFreemarkerModel());
    WebFault webFault = new WebFault((ClassDeclaration) getDeclaration("net.sf.enunciate.samples.services.ImplicitWebFaultTwo"));
  ...
  public void testExplicitWebFault() throws Exception {
    FreemarkerModel.set(new EnunciateFreemarkerModel());
    WebFault webFault = new WebFault((ClassDeclaration) getDeclaration("net.sf.enunciate.samples.services.ExplicitFaultBean"));
  ...
  public void testAlmostExplicitWebFault1() throws Exception {
    FreemarkerModel.set(new EnunciateFreemarkerModel());
    WebFault webFault = new WebFault((ClassDeclaration) getDeclaration("net.sf.enunciate.samples.services.AlmostExplicitFaultBeanOne"));
  ...
  public void testAlmostExplicitWebFault2() throws Exception {
    FreemarkerModel.set(new EnunciateFreemarkerModel());
    WebFault webFault = new WebFault((ClassDeclaration) getDeclaration("net.sf.enunciate.samples.services.AlmostExplicitFaultBeanTwo"));
