...
public class TestJsonObjectTypeDefinition extends InAPTTestCase
{
    ...
    public void testProperties_NameOverride()
    {
        ...
        final Map<String, Property> actualNameProperties = nameTypeDefinition.getPropertiesByName();
    ...
    public void testProperties_AnnotationRequired()
    {
        ...
        final Map<String, Property> actualPersonProperties = personTypeDefinition.getPropertiesByName();
    ...
    private void assertProperty(final String expectedName, final String expectedDocComment, final String expectedTypeName, final Property actualProperty)
    {
        assertNotNull(actualProperty);
        assertEquals(expectedName, actualProperty.getName());
        assertEquals(expectedDocComment, actualProperty.getDescription());
        assertEquals(expectedTypeName, actualProperty.getType().toString());
    }
}
