...
package org.codehaus.enunciate.modules.resteasy;
...
import org.codehaus.enunciate.modules.resteasy.config.RESTEasyRuleSet;
...
/**
 * <h1>RESTEasy Module</h1>
 *
 * <p>The RESTEasy module assembles a RESTEasy-based server-side application for hosting the REST endpoints.</p>
 *
 * <p>Note that the RESTEasy module is disabled by default, so you must enable it in the enunciate configuration file, e.g.:</p>
 *
 * <code class="console">
 * &lt;enunciate&gt;
 * &nbsp;&nbsp;&lt;modules&gt;
 * &nbsp;&nbsp;&nbsp;&nbsp;&lt;jaxws-ri disabled="true"/&gt;
 * &nbsp;&nbsp;&nbsp;&nbsp;&lt;resteasy disabled="false"&gt;
 * &nbsp;&nbsp;&nbsp;&nbsp;...
 * &nbsp;&nbsp;&nbsp;&nbsp;&lt;/resteasy&gt;
 * &nbsp;&nbsp;&lt;/modules&gt;
 * &lt;/enunciate&gt;
 *
 * <p>You should also be aware that the RESTEasy module is not, by default, on the classpath when invoking Enunciate. For more information,
 ...
 *
 * <p>The RESTEasy module supports the following configuration attributes:</p>
 *
 * <ul>
 ...
 * </ul>
 *
 * <p>The RESTEasy module also supports a list of <tt>option</tt> child elements that each support a 'name' and 'value' attribute. This can be used to configure the RESTEasy
 ...
 *
 * <p>The RESTEasy deployment module exports no artifacts.</p>
 *
 * @author Ryan Heaton
 * @docFileName module_resteasy.html
 */
public class RESTEasyDeploymentModule extends FreemarkerDeploymentModule implements EnunciateClasspathListener, SpecProviderModule {
  ...
  public void initModel(EnunciateFreemarkerModel model) {
    ...
    if (!isDisabled()) {
      ...
      if (!servletFound) {
        warn("The RESTEasy runtime wasn't found on the Enunciate classpath. This could be fatal to the runtime application.");
      }
    }
  }
