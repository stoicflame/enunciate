...
import org.codehaus.enunciate.examples.php.schema.animals.Cat;
import org.codehaus.enunciate.examples.php.schema.draw.Canvas;
import org.codehaus.enunciate.examples.php.schema.structures.House;
import org.codehaus.enunciate.examples.php.schema.vehicles.Bus;
 ...
 * @author Ryan Heaton
 */
public class TestPHPXmlSerialization extends TestCase {
  ...
  protected void setUp() throws Exception {
    ...
    if (!this.skipPHPTests) {
      ...
      String exe = System.getProperty("processxml.php");
      if (exe == null) {
        throw new IllegalStateException("The path to the processxml script must be supplied via property 'processxml.php'.");
      }
...
//    assertEquals(3, attachmentCount);
  ...
  protected <T> T processThroughXml(T object) throws Exception {
    ...
    assertEquals("php process xml failed.", 0, exitStatus);
