...
public class ResourceImpl implements Resource {
  ...
  public String getDeprecated() {
    String message = ElementUtils.findDeprecationMessage(this.requestMapping, this.registrationContext.getTagHandler());
    if (message == null) {
      message = ElementUtils.findDeprecationMessage(this.requestMapping.getParent(), this.registrationContext.getTagHandler());
    }
    return message;
  }
  ...
  public List<String> getSeeAlso() {
    JavaDoc.JavaDocTagList tags = this.requestMapping.getJavaDoc(this.registrationContext.getTagHandler()).get("see");
    if (tags == null) {
      tags = this.requestMapping.getParent().getJavaDoc(this.registrationContext.getTagHandler()).get("see");
    }
    if (tags == null) {
      tags = ((DecoratedElement) this.requestMapping.getParent().getPackage()).getJavaDoc(this.registrationContext.getTagHandler()).get("see");
    }
    return tags;
  }
