...
public class FormDataMediaTypeDescriptor implements MediaTypeDescriptor {
  ...
  private String getSlug() {
    return method.getSimpleNameString() + "_data";
  }
  ...
  private class FormDataType implements DataType {
    ...
    public List<? extends Property> getProperties() {
      return method.getRequestParameters().stream().filter(param -> StringUtils.equals("form", param.getTypeName())).map(ParameterProperty::new).collect(Collectors.toList());
    }
  ...
  private class ParameterProperty implements Property {
    ...
    @Override
    public DataTypeReference getDataType() {
      return MediaTypeUtils.isMultipartFormData(FormDataMediaTypeDescriptor.this.mediaType) ? CustomDataTypeReference.binary() : new CustomDataTypeReference(BaseType.string);
    }
  ...
  private class UrlEncodedExample implements Example {
    ...
    public String getBody() {
      return method.getRequestParameters().stream().filter(param -> StringUtils.equals("form", param.getTypeName())).map(param -> param.getParameterName() + "=...").collect(Collectors.joining("&"));
    }
  }
  ...
  private class MultipartFormEncodedExample implements Example {
    ...
    @Override
    public String getBody() {
      return method.getRequestParameters().stream().filter(param -> StringUtils.equals("form", param.getTypeName()))
