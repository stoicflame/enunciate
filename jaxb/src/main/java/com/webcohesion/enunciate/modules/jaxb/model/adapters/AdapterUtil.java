...
public class AdapterUtil {
   ...
   */
  public static AdapterType findAdapterType(Element declaration) {
   ...
   */
  private static AdapterType findAdapterType(TypeMirror unwrappedAdaptedType, Element referer, PackageElement pckg) {
   ...
   */
  private static Map<String, XmlJavaTypeAdapter> getAdaptersOfPackage(PackageElement pckg) {
    HashMap<String, XmlJavaTypeAdapter> adaptersOfPackage = ADAPTERS_BY_PACKAGE.get(pckg.getQualifiedName().toString());

    if (adaptersOfPackage == null) {
      adaptersOfPackage = new HashMap<String, XmlJavaTypeAdapter>();
      ADAPTERS_BY_PACKAGE.put(pckg.getQualifiedName().toString(), adaptersOfPackage);
